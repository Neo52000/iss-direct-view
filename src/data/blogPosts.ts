...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription:
      "Guide complet pour observer la Station Spatiale Internationale à l'œil nu depuis la France : créneaux, luminosité, conditions météo, applications et erreurs à éviter.",
    excerpt:
      "Pas besoin de télescope : la Station Spatiale est l'un des objets les plus brillants du ciel nocturne. Voici comment la repérer, sans rien manquer.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "L'image du live ISS devient noire, bleue ou grise par moments : les vraies raisons techniques, et comment savoir si le flux fonctionne toujours.",
    excerpt:
      "Trois raisons principales expliquent ces interruptions visuelles du flux en direct — aucune n'est un signe de panne.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "L'ISS orbite entre 400 et 420 km d'altitude, en orbite terrestre basse. Pourquoi cette hauteur, comment elle est entretenue, et comment elle se compare aux autres satellites.",
    excerpt:
      "Une orbite basse permet une logistique simplifiée — au prix d'un entretien régulier, sous peine de retomber.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "L'ISS effectue environ 15,5 à 16 orbites complètes autour de la Terre chaque jour, soit un lever de soleil toutes les 90 minutes. Explications et conséquences pour l'équipage.",
    excerpt:
      "16 levers et couchers de soleil par jour pour les astronautes : c'est le rythme imposé par l'orbite, très loin du cycle terrestre habituel.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "L'ISS file à environ 27 600-28 000 km/h, soit près de 7,7 km par seconde. Explications physiques et comparaisons concrètes.",
    excerpt:
      "Près de huit kilomètres parcourus chaque seconde : pourquoi est-il indispensable d'aller aussi vite pour rester en orbite ?",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "Guide pratique pour photographier le passage de l'ISS avec un smartphone : réglages, mode nuit, pose longue, erreurs à éviter.",
    excerpt:
      "Avec le mode nuit ou astrophotographie, un smartphone récent peut immortaliser une trace lumineuse de l'ISS — à condition de bien s'y préparer.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "Kit gratuit d'activités espace à imprimer : coloriages, quiz, fiches pédagogiques sur l'ISS et le système solaire, pour la maison ou la classe.",
    excerpt:
      "Coloriages, quiz, fiches pédagogiques : de quoi occuper un mercredi après-midi tout en apprenant, sans écran.",
    content:
  ...
  },
  {
    ...
    metaDescription:
      "Pistes pédagogiques concrètes pour présenter la Station Spatiale Internationale en classe de primaire : comparaisons, expériences simples, supports visuels.",
    excerpt:
      "Comparaisons concrètes, expériences simples et supports visuels pour rendre l'ISS accessible aux 6-10 ans, sans jargon scientifique.",
    content:
  ...
  },
  {
    ...
    excerpt: "Cinq coloriages gratuits pour découvrir l'ISS et l'espace à la maison ou en classe.",
    content:
